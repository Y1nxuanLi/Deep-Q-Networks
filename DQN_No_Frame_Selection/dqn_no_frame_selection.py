...
if __name__ == "__main__":
    ...
    Deep_Q_Learning(env, buffer_size=100_000, nb_epochs=5_000_000, exploration_steps=1_000_000, replay_start_size=50_000, train_frequency=1, device='cuda', C=10_000)
